...
/*
 * SpadeFS.java - SPADE filesystem using javaFUSE.
 * Implements the JavaFS interface.
 */
...
public class SpadeFS implements javafuse.JavaFS, DBconstants
{
    private SpadeDB bdb;
    ...
    static
    {
        System.loadLibrary("javafuse");
    }

    public SpadeFS()
    {
        System.out.println("CONSTRUCTOR");
        //bdb = new BerkeleyDB("/homes/adityar/spade/javafuse/fs/spade/dbEnv");
        context = new Fuse_context();
    }
    ...
    public int getattr_post(String path, Stat buf, int result)
    {
        ...
        context.copyContextIn();
        System.out.println(context.uid);
        return 0;
    }
    ...
    {
        // If lineage from this file is not in DB, put it.
        return 0;
    }
    ...
    {
        // If eof was reached in sys call (result == 0), add lineage.
        return 0;
    }
